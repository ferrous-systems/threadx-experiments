...
* [`stm32u5-app`](./stm32u5-app/) - a Rust application for the STM32U5A5 which uses ThreadX as its kernel; it automatically compiles ThreadX to a static library and links to it. You need an NUCLEO-U5A5ZJ-Q board to run this binary. This app runs in Secure state, so TZEN=1 must be set.
